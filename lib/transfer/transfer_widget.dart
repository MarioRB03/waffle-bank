    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: [
                          FFLocalizations.of(context).getText(
                            'nxxoqwzn' /* Internal Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            'eybhcmsg' /* External Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            'v43woz88' /* ACH Payment */,
                          )
                        ],
                        onChanged: (val) =>
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: [
                          FFLocalizations.of(context).getText(
                            'dqen1ik2' /* Select Account */,
                          ),
                          FFLocalizations.of(context).getText(
                            'vwvy22po' /* Account ****2010 */,
                          ),
                          FFLocalizations.of(context).getText(
                            'jr1gm8h4' /* Account ****2011 */,
                          ),
                          FFLocalizations.of(context).getText(
                            'pjhzrtbq' /* Account ****2012 */,
                          )
                        ],
                        onChanged: (val) =>
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'u82pphki' /* Your new account balance is: */,
                            ),
          ...
          Text(
            FFLocalizations.of(context).getText(
              'vk881u2p' /* Tap above to complete transfer */,
            ),
